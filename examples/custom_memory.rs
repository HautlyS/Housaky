//! Example: Implementing a custom Memory backend for Housaky
//!
...
// ── Re-define the trait types (in your app, import from housaky::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Housaky Memory Demo — InMemoryBackend\n");
