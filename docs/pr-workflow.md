# Housaky PR Workflow (High-Volume Collaboration)

This document defines how Housaky handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Housaky/project-native labels.
...
- Confirm any required identity-like wording uses Housaky/project-native terminology.
