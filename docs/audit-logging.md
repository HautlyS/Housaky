# Audit Logging for Housaky

## Problem
Housaky logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/housaky/audit.key"
...
housaky audit --user @alice

# Show all high-risk commands
housaky audit --risk high

# Show violations from last 24 hours
housaky audit --since 24h --violations-only

# Export to JSON for analysis
housaky audit --format json --output audit.json
