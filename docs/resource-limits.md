# Resource Limits for Housaky

## Problem
Housaky has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for housaky with limits.
