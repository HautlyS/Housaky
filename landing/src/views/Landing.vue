...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    feat_nodes_title: 'Anonymous Peers', feat_nodes_desc: 'QUIC-encrypted peer network. Share code, tools, learnings. 100% private, no device access.',
  ...
  es: {
    ...
    feat_nodes_title: 'Pares Anonimos', feat_nodes_desc: 'Red de pares cifrada con QUIC. Comparte codigo, herramientas, aprendizajes. 100% privado.',
...
╚██████╔╝██║     ╚██████╔╝    ██║  ██║╚██████╔╝██║  ██╗╚██████╔╝███████╗
 ╚═════╝ ╚═════╝  ╚═════╝     ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚══════╝
      ...
      <nav class="nav">
        <a :href="base + '/'">[{{ t('nav_home').value }}]</a>
        <a :href="base + '/#features'">[{{ t('nav_features').value }}]</a>
        <a :href="base + '/A2A/'">[A2A HUB]</a>
        <a :href="base + '/#install'">[{{ t('nav_install').value }}]</a>
    ...
    <main class="main">
      ...
      <section id="home" class="card mb-4 fade-in">
        <div class="card-body text-center p-4">
          ...
          <div class="flex justify-center gap-2 flex-wrap">
            <a :href="base + '/#install'" class="btn btn-lg">{{ t('nav_install').value }}</a>
            <a :href="base + '/A2A/'" class="btn btn-lg">A2A HUB</a>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="feature-list">
              ...
              <li>
                <span class="font-bold">{{ t('feat_nodes_title').value }}</span>
                <div style="color: var(--text-dim); font-size: 10px;">{{ t('feat_nodes_desc').value }}</div>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section id="a2a" class="card mb-4 a2a-promo">
        ...
        <div class="card-body text-center p-4">
          ...
          <a :href="base + '/A2A/'" class="btn btn-lg">{{ t('a2a_cta').value }}</a>
        </div>
      </section>
