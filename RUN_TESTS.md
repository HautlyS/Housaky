...
```bash
# Check config
cat ~/.housaky/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time housaky channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   housaky daemon
   # or
   RUST_LOG=info housaky channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/housaky/issues
